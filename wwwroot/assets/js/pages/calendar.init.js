...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var g = new bootstrap.Modal(document.getElementById("event-modal"), {
        ...
        y = [ {
            id: 112,
            title: "เล่นเพลงชาติไทย",
            start: new Date(e, n, t, 12, 30),
            allDay: !0,
            className: "bg-soft-success",
            location: "กลุ่มหนองไม้ไผ่",
            extendedProps: {
                department: "Meeting"
            },
            description: "เล่นเพลงประจำวัน"
        }, {
            id: 113,
            title: "เล่นเพลงชาติกัมพูชา",
...
var str_dt = function (e) {
    var e = new Date(e),
        t = "" + ["มกราคม", "กุมภาพันธ์", "มีนาคม", "เมษายน", "พฤษภาคม", "มิถุนายน", "กรกฎาคม", "สิงหาคม", "กันยายน", "ตุลาคม", "พฤษจิกายน", "ธันวาคม"][e.getMonth()],
        n = "" + e.getDate(),
        e = e.getFullYear();
